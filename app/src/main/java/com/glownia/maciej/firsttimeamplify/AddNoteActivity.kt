...
class AddNoteActivity : AppCompatActivity() {
    ...
    /**
     * Consumes the selected image as an InputStream, twice.
     * The first InputStream creates a Bitmap image to display in the UI,
     * the second InputStream saves a temporary file to send to the backend.
     * This module goes through a temporary file because the Amplify API consumes Fileobjects.
     * While not the most efficient design, the code is simple.
     */
